  ...
  return (
    <div className="zt-container zt-section max-w-3xl">
      ...
      <div className="prose prose-slate mt-8 max-w-none text-sm leading-relaxed text-slate-700">
        ...
        <h2 className="mt-8 text-lg font-bold text-zinc-800">1. 수집하는 개인정보 항목</h2>
        <p>도입 문의 시: 회사명, 담당자 성명, 이메일, 연락처, 문의 내용</p>
        <h2 className="mt-8 text-lg font-bold text-zinc-800">2. 이용 목적</h2>
        <p>서비스 상담·견적 안내, 계약 이행, 고객 지원</p>
        <h2 className="mt-8 text-lg font-bold text-zinc-800">3. 문의</h2>
        <p>
          개인정보 관련 문의:{" "}
