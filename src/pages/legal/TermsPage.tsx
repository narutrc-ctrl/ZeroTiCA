...
export function TermsPage() {
  return (
    <div className="zt-container zt-section max-w-3xl">
      <h1 className="text-3xl font-bold text-zinc-800">이용약관</h1>
      ...
      <div className="prose prose-slate mt-8 max-w-none text-sm leading-relaxed text-slate-700">
        ...
        <h2 className="mt-8 text-lg font-bold text-zinc-800">1. 서비스</h2>
        <p>
          회사는 네트워크 보안 모니터링·위협 분석·보고 서비스(Insight, Watch)를 제공하며, 고객은
          계약에 따라 {site.productPortal} 고객 포털을 이용할 수 있습니다.
        </p>
        <h2 className="mt-8 text-lg font-bold text-zinc-800">2. 문의</h2>
        <p>
          약관 관련 문의:{" "}
