...
export const customerValueZones: CustomerValueZone[] = [
  ...
  },
  {
    ...
    title: "위협 이외 — 발견과 정리",
    lead: [
      "모든 통신이 곧바로 위협은 아닙니다. 몰랐던 업무 통신과, 정책·예외로 정리해야 할 패턴도 같은 이슈 흐름으로 다룹니다.",
...
export const taskCaseStudies: TaskCaseStudy[] = [
  ...
  },
  {
    ...
    findings: [
      "내부 호스트 → 외부 IP 장시간 세션",
      "Kerberos·프로세스 정보와 함께 이슈에 근거 첨부",
    ],
  ...
  },
  {
    ...
    direction: "측면이동",
    summary:
      "워터링홀 침해사고 협조 요청에 따라, 언론사→에너지 경제 서버(SSH) 침투 경로와 웹쉘·권한 상승 흔적을 이슈·보고서로 종합 정리했습니다.",
    findings: [
    ...
    staffAsk:
      "국가기관 협조 요청에 따른 침해사고 분석·조치 내역을 이슈에 정리해 주세요.",
...
export const primaryOutcomeHighlight = {
  ...
  body: "위협 통신은 Outbound·Inbound·Lateral 관점에서 분석하고, 몰랐던 통신·정리가 필요한 패턴도 이슈로 남깁니다. 확인·검증·조치·화이트리스트까지 한 흐름으로 이어집니다.",
};
...
export const journeyStepExamples: JourneyStepExample[] = [
  ...
  },
  {
    step: "05",
    focus: "notify",
    headline: "고객 포털에 도착하는 확인 요청 (선별된 이슈만)",
