...
import { paths, serviceDecision, services } from "@/data/content";
import { cn } from "@/lib/cn";

export function ServiceDecisionSection() {
  return (
    <section id="choose" className="border-b border-slate-200 bg-gradient-to-b from-white to-slate-50">
      <div className="zt-container zt-section">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          <a href="#faq" className="zt-btn-ghost">
            자주 묻는 질문 <ArrowRight className="h-4 w-4" />
          </a>
        </div>
      </div>
    </section>
